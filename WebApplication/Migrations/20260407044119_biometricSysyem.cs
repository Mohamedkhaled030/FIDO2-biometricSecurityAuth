...
{
    /// <inheritdoc />
    public partial class biometricSysyem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttestationClientDataJson = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    AttestationFormat = table.Column<string>(type: "nvarchar(max)", nullable: false),
